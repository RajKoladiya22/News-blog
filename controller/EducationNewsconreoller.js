const NewsModel = require('../models/EducationNewmodels');
const fs = require('fs');

const AdminPage = async(req, res)=>{
    return res.render('pages/index')
}
const addEducationNews = async(req, res)=>{
    return res.render('pages/education');
}
...
const View = async(req, res)=>{
    try {
        let education = await NewsModel.find({});
        return res.render('index', { education }); 
